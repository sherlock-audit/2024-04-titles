...
contract FeeManager is Ownable {
    ...
    /// @notice Thrown when an insufficient funds error occurs (i.e. when the amount received is less than the expected fee).
    ...
    /// @dev This function is only callable by the owner (i.e. the {TitlesCore} contract)
